import{p as ve,s as fe,q as ge,t as be,M as g,u as se,R as l,i as v,r as P,a as f,b as a,v as K,e as ce,o as le,j as m,f as Y,k as ye,x as S,E as ie,O as E,C as q,y as oe,l as T,A as H,T as xe,z as Ce,c as ke,h as Se}from"./core-CGlGFhse.js";import{c as u,n as w,r as d,o as F,U as We}from"./index-C7UIDcqH.js";import"./index-CT5Fd7gI.js";import"./index.es-BMbDqRjF.js";import"./useSwitchChain-DWGuqqfR.js";import"./useInfiniteQuery-B1hqokRv.js";import"./index-BbP3371Q.js";import"./index.es-BjkdSBqQ.js";import"./index-nibyPLVP.js";import"./fallback-8l7l4cQM.js";const p=be({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return ge(p,()=>r(p))},subscribeKey(r,e){return fe(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=ve(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
